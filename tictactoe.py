...
def inputPlayerLetter():
    ...
    # The first letter in the list is the player's letter; the second
...
def isWinner(bo, le):
    ...
    # We use bo instead of board and le instead of letter to save on typing
    return ((bo[7] == le and bo[8] == le and bo[9] == le) or# Across the top
            ...
            (bo[3] == le and bo[6] == le and bo[9] == le) or# Down the right
    ...
    while gameIsPlaying:
        if turn == 'player':
            ...
            if isWinner(theBoard, computerLetter):
                drawBoard(theBoard)
                print('The computer has won, unlucky!')
                gameIsPlaying = False
            else:
                if isBoardFull(theBoard):
                    drawBoard(theBoard)
